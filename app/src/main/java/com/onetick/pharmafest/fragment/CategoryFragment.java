...
import com.onetick.pharmafest.databinding.FragmentCategoryBinding;
import com.onetick.pharmafest.model.CatList;
import com.onetick.pharmafest.model.Category;
 ...
 */
public class CategoryFragment extends Fragment implements GetResult.MyListener , CategoryAdapter.RecyclerTouchListener{
    ...
    private void getCategory(int pageno) {
        ...
        getResult.callForLogin(call, "category", getContext());
    }
    ...
    public void callback(JsonObject result, String callNo) {
        ...
        try {
            if (callNo.equalsIgnoreCase("category")) {
                ...
                catLists.addAll(category.getCategoryData());
                totalPages = category.getTotalPages();
                if (category.getResult().equalsIgnoreCase("true")) {
                    categoryAdapter = new CategoryAdapter(getActivity(), catLists, "viewall", this::onClickCategoryItem);
    ...
    @Override
    public void onClickCategoryItem(String titel, int position, String catId) {
        Bundle args = new Bundle();
