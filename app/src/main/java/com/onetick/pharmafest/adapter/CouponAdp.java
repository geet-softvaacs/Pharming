...
public class CouponAdp extends RecyclerView.Adapter<CouponAdp.ViewHolder> {
    ...
    public CouponAdp(Context mContext, List<Couponlist> couponsList, RecyclerTouchListener listener, int amount) {
    ...
    @NonNull
    @Override
    public CouponAdp.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CouponAdp.ViewHolder holder, int position) {
        ...
        holder.txtAmount.setText("Max. Discount "+sessionManager.getStringData("currency") + coupon.getCValue());
    ...
    private static SpannableStringBuilder addClickablePartTextViewResizable(final Spanned strSpanned, final TextView tv,
        ...
        if (str.contains(spanableText)) {
            ...
            ssb.setSpan(new com.onetick.pharmafest.adapter.CouponAdapter.MySpannable(false){
                @Override
